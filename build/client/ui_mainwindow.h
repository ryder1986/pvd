...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        textEdit_output = new QTextEdit(widget_device);
        textEdit_output->setObjectName(QStringLiteral("textEdit_output"));

        gridLayout_2->addWidget(textEdit_output, 1, 1, 1, 1);

        textEdit_config = new QTextEdit(widget_device);
        textEdit_config->setObjectName(QStringLiteral("textEdit_config"));

        gridLayout_2->addWidget(textEdit_config, 0, 0, 1, 3);

        textEdit_input = new QTextEdit(widget_device);
        textEdit_input->setObjectName(QStringLiteral("textEdit_input"));

        gridLayout_2->addWidget(textEdit_input, 1, 0, 1, 1);
        ...
        gridLayout_3->addWidget(pushButton_reboot, 0, 1, 1, 1);


        gridLayout->addWidget(widget_cmd_area, 12, 0, 1, 1);
        ...
        gridLayout->addWidget(pushButton_insert, 3, 0, 1, 1);
        ...
        menuBar->setGeometry(QRect(0, 0, 1584, 25));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_insert->setText(QApplication::translate("MainWindow", "set", 0));
        pushButton_delete->setText(QApplication::translate("MainWindow", "clear", 0));
